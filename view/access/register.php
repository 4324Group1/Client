...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Register a new membership</p>
     <p class="login-box-msg"><?php include_once('src/registry.php'); ?></p>
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="registry" class="btn btn-primary btn-block btn-flat">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<script src="dist/js/jquery.validationEngine-vi.js" type="text/javascript" charset="utf-8"></script>
